...
# given a set of pitches, adjust them so that they sound more harmonious 
...
def generate_music(trajectories, img):
    ...
    for i in range(len(trajectories_best)):
        ...
        if i > len(players_melody)-1:
            ...
            lpf  *= attenuation**2
            # print("lpf is ", lpf)
            melody_attrs[i] = (pitch, vol, dur, pan, lpf)
